...
from app.models import CommandPayload, FlagPayload
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(title="NovaOps Backend", version="2.0.0")
    ...
    async def apply_command(command: CommandPayload) -> list[dict]:
        ...
        runtime.actuator_states[command.name] = command.state
    ...
    @app.post("/api/flags/calibration")
    ...
    @app.post("/api/flags/data-saving")
